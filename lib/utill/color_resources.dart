...
class ColorResources {
 ...
 // primary Color
  static const Color DARK_BLUE = Color(0xFFD32F2F);
  // Text Color
  static const Color DARK_BLUE2 = Color(0xFFD32F2F);
  ...
  static const Color Yellow_Golden = Color(0xFFFFDF00);
  static const Color GOLD = Color(0xFFFFD700);
  static const Color ORANGE = Color(0xFFDE7B07);
