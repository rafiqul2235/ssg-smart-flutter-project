...
class LocationRepo {
  ...
  double getDistanceInKiloMeter(LatLng originLatLng, LatLng destinationLatLng){
    var p = 0.017453292519943295;
    var a = 0.5 - cos((destinationLatLng.latitude - originLatLng.latitude) * p)/2 +
        cos(originLatLng.latitude * p) * cos(destinationLatLng.latitude * p) *
            (1 - cos((destinationLatLng.longitude - originLatLng.longitude) * p))/2;
