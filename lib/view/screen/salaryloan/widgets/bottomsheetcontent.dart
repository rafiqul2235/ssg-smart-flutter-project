...
class BottomSheetContentForSalaryAdv extends StatefulWidget {
  final SalaryAdvInfo salaryAdvInfo;

  const BottomSheetContentForSalaryAdv({Key? key, required this.salaryAdvInfo}) : super(key: key);

  @override
  _BottomSheetContentForSalaryAdvState createState() => _BottomSheetContentForSalaryAdvState();
}

class _BottomSheetContentForSalaryAdvState extends State<BottomSheetContentForSalaryAdv> {
