...
class SupervisorDeliveryInfoScreen extends StatefulWidget {
  final bool isBackButtonExist;
  const SupervisorDeliveryInfoScreen({Key? key, this.isBackButtonExist = true})
      : super(key: key);

  @override
  State<SupervisorDeliveryInfoScreen> createState() => _SupervisorDeliveryInfoScreenState();
}

class _SupervisorDeliveryInfoScreenState extends State<SupervisorDeliveryInfoScreen> {
