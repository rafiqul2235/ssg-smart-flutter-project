...
class SrSalesApprovalScreen extends StatefulWidget {
  final bool isBackButtonExist;
  const SrSalesApprovalScreen({Key? key, this.isBackButtonExist = true})
      : super(key: key);
  @override
  State<SrSalesApprovalScreen> createState() => _SrSalesApprovalScreenState();
}

class _SrSalesApprovalScreenState extends State<SrSalesApprovalScreen> {
