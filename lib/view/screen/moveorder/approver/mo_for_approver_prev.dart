...
class ApprovalMoveOrderScreenPrev extends StatefulWidget {
  final bool isBackButtonExist;
  const ApprovalMoveOrderScreenPrev({Key? key, this.isBackButtonExist = true}) : super(key: key);

  @override
  _ApprovalMoveOrderScreenPrevState createState() => _ApprovalMoveOrderScreenPrevState();
}

class _ApprovalMoveOrderScreenPrevState extends State<ApprovalMoveOrderScreenPrev> {
